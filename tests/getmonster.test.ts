...
import { getMonster } from '../axios.js';
...
describe('getMonster', () => {
  test('should return monster schema', async () => {
    const data = {
      index: 'aboleth',
      name: 'Aboleth',
      size: 'Large',
    ...
    } as unknown as GetMonsterResponseSchema;
    mockedAxios.get.mockResolvedValue({ data: data });

    const result = await getMonster('/api/monsters/aboleth');
